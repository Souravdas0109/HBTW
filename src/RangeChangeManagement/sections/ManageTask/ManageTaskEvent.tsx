          ...
          for (var i = 0; i < data.length; i++) {
            if (
              ...
              successData.push({
                ...
                planogramClass: data[i].planogramClass,
                planogramClassString:
                  data[i].planogramClass && data[i].planogramClass.className
                    ? data[i].planogramClass.className.toString()
                    : '',
                wastageRange: data[i].wastageRange,
                wastageRangeText: data[i].wastageRangeText,
                buyer: data[i].buyer,
                ...
                orderStopDateCheck: data[i].orderStopDateCheck,
